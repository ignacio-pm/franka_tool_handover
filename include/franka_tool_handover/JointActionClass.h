...
class JointAction {
  protected:
    ...
    actionlib::SimpleActionClient<franka_tool_handover::JointImpedanceAction> ac;
    
    ros::Subscriber sub = node_handle_.subscribe("/joint_states", 100, statesCallback, 
  ...
  public:
    ...
    void statesCallback(const sensor_msgs::JointState &msg);
